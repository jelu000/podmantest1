...
function App() {
  ...
  const [selectedDayApp, setSelectedDayAppTf] = useState("datum");

  // En funktion för att ändra det valda datumet/texten
  const handleSetTfText = (dateString) => {
      setSelectedDayAppTf(dateString);
  };
  ...
  return (
    <div className="App">
      ...
      <DeadlinePicker onValtDatum={handleSetTfText} />
      <input type='text' id='input_text' size="10" readOnly value={selectedDayApp}/>
      <br />
    </div>
  );
}
